...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_folds', type=int, default=1, help='Number of folds for cross validation')
    parser.add_argument('--num_classes', type=int, default=2, help='Number of classes')
    parser.add_argument('--use_claim_source', type=int, default=0, help='Using claim source embedding or not')
    parser.add_argument('--use_article_source', type=int, default=0, help = 'Using article source embedding or not')
